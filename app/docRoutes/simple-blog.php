...
Route::group(array('prefix'=>'simple-blog'), function()
{
    $routeName    = 'simple-blog';
    $docDirectory = 'how-use-laravel-create-a-simple-blog';
    $view         = 'simple-blog';
    ...
    Route::get('/', array('as'=>$routeName, function() use($routeName, $docDirectory, $view)
    {
        ...
        foreach ($allFilesArray as $key => $value)
        {
            ...
            if (starts_with($key, 'file')) continue; // 忽略文件目录（递归）
