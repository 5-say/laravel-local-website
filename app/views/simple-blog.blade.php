...
<head>
    <title>laravel 4.1 简单博客教程</title>
    ...
    <div id="wrapper">
        ...
        <header id="header" role="header" style="height:3em;">
            <div class="boxed">
                ...
                <div id="version">
                    <ul class="nolist">
                        <li><a target="_blank" href="https://github.com/5-say/how-use-laravel-create-a-simple-blog" title="Dev">Github</a></li>
                    </ul>
                </div>
                <!-- /version -->
            </div>
        ...
        <nav id="primary" style="height:1.5em;">
            <div class="boxed">
                <ul>
                    ...
                    <li{{ $is_active('README.md') }}><a href="{{ route('simple-blog') }}/README.md">readme.md</a></li>
                    <li{{ $is_active('index') }}><a href="{{ route('simple-blog') }}">索引</a></li>
